                        ...
                        const allSections = [
                          ...
                          ...(rc ? [{
                            ...
                            items: [
                              ...
                              { key: 'comfort',     label: 'Comfort Zone Index',   desc: rc.comfortZoneIndex !== null ? `Win% vs lower-ranked ÷ win% vs higher-ranked. 1.0× = equally strong at all levels; above 1.5× = results rely heavily on beating weaker players. · ${rc.comfortZoneIndex > 1.5 ? 'Over-reliant on weaker opponents' : rc.comfortZoneIndex < 1.1 ? 'Balanced across all ranks' : 'Moderate rank dependency'}` : 'Win% vs lower-ranked ÷ win% vs higher-ranked — insufficient data across both groups', value: rc.comfortZoneIndex !== null ? `${rc.comfortZoneIndex.toFixed(2)}×` : '—', accent: rc.comfortZoneIndex !== null && rc.comfortZoneIndex <= 1.3 ? '#10b981' : '#f59e0b', matches: rc.vsRankedMatches || [] },
                            ],
                          }] : []),
                          {
                            key: 'mental',
